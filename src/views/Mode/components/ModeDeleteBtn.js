...
class ModeDeleteBtn extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="animated fadeIn">
        ...
        <Dropdown isOpen={this.state.dropdownOpen[0]} toggle={() => {
          ...
          <DropdownMenu>
            <DropdownItem className='bg-danger text-center' onClick={()=>this.props.toggleModeModalDelete(this.props.id)}>Delete</DropdownItem>
