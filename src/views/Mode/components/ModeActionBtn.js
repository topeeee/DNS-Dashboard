      ...
      <div className="animated fadeIn">
        ...
        <Dropdown isOpen={this.state.dropdownOpen[0]} toggle={() => {
          ...
          <DropdownMenu>
            ...
            <DropdownItem className='bg-info text-center p-0' onClick={()=>this.props.toggleModeModalUpdate(this.props.id)}>Update</DropdownItem>
...
export default connect(null, mapDispatchToProps)(ModeActionBtn);
