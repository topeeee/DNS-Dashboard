              ...
              <CardBody>
                <Dropdown isOpen={this.state.dropdownOpen[0]} toggle={() => {
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownItem className='bg-danger text-center' onClick={this.props.toggleUserModalCreate}>Delete</DropdownItem>
                    <DropdownItem className='bg-info text-center'>Update</DropdownItem>
                    {/*<DropdownItem divider />*/}
                    <DropdownItem className='bg-warning text-center'>Change Status</DropdownItem>
                  </DropdownMenu>
                </Dropdown>
              </CardBody>
            </Card>
