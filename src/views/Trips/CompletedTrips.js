...
const CompletedTrips = ({getTrips, trips, trip, isLoading,  searchTrip, error, users, getUsers}) => {
          ...
          <Card>
            ...
            <CardBody>
              ...
              <Table responsive hover>
                ...
                <tbody>
                {trips && trips.sort((a, b) => parseFloat(b.id) - parseFloat(a.id)).filter((user) => user.pickStatus === "1" && user.dropStatus === "1").map((user, index) =>
