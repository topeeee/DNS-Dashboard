...
import {toggleOperatorModalCreate} from "../../../../store/actions/operatorAction";
...
const OperatorHeader = ({toggleOperatorModalCreate})=> {
  return (
    <div className="text-right w-75">
      <button className="btn btn-instagram float-right" onClick={()=> toggleOperatorModalCreate() }>Create</button>
