...
const InActivePartners = ({getPartners, partners, isLoading}) => {
          ...
          <Card>
            ...
            <CardBody>
              ...
              <Table responsive hover>
                ...
                <tbody>
                {(partners && isAdmin)? partners.sort((a, b) => parseFloat(b.id) - parseFloat(a.id)).filter((user) => user.status == 0).map((operator, index) =>
